                    ...
                    <div class="col-lg-8">
                        <form class="form-contact" action="contact_process.php" method="post" id="feedback">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-subject">
                                        <input name="cellno" style="width:auto;" id="cellno" type="text" pattern="[0-9]+" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter you cellno'" placeholder="Cell No." required>
                                    </div>
                                </div>
                            </div>
